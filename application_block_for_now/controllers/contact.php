...
class Contact extends CI_Controller {
	...
	public function download($filename) {
 		...
 		$list = array('anankitpatil@gmail.com', 'michelle@renewdesign.co.uk');
		$this->load->library('email');
		...
		if($this->email->send()) {
			echo '<a href="http://renewgroupuk.com/wheelwash/pdf/' . $filename . '" target="_blank" class="button download final">Download PDF file(Opens in new window)</a>';
		} else {
