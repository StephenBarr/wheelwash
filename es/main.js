...
// News Slider
	...
	$('.news-content li').find('p').css('width', (shft - 180) + 'px');
		...
		$('.map-container').find('.button').click(function(e) {
			...
			switch (sel) { 
				...
				case 'ireland': 
					...
					$('.map-info').find('.title').html('IRLANDA');
					$('.map-left').find('img').replaceWith('<img src="img/space.jpg" />');
				...
				case 'spain': 
					...
					$('.map-info').find('.title').html('ESPANA');
				...
				case 'gbritain': 
					...
					$('.map-info').find('.title').html('REINO UNIDO');
				...
				case 'germany': 
					...
					$('.map-info').find('.title').html('ALEMANIA');
					$('.map-left').find('img').replaceWith('<img src="img/space.jpg" />');
				...
				case 'newzealand': 
					...
					$('.map-info').find('.title').html('NUEVA ZELANDA');
					$('.map-left').find('img').replaceWith('<img src="img/space.jpg" />');
				...
				case 'norway': 
					...
					$('.map-info').find('.title').html('SUECIA / NORWEIGA');
					$('.map-left').find('img').replaceWith('<img src="img/space.jpg" />');
...
//PDF Download Script
	$('.productbottomleft .download').click(function(e) {
		...
		var overlay = $('<div class="black-out"><div class="pdf-content"><form class="pdform"><label>Nombre</label><input type="text" class="name" name="name" value="Introduzca su nombre..." /><label>E-mail</label><input name="email" class="email" value="Introduzca su E-mail..." /><input type="submit" value="Download" class="download button" /></div></form></div></div>');
		
		overlay.css('opacity', 0);
		$('body').append(overlay);
		overlay.animate({'opacity': 1}, 500, function() {
			$('.pdf-content input[name=name]').focus(function() { 
				if($(this).val() == 'Introduzca su nombre...') $(this).val('');
			}).blur(function() {
				if($(this).val() == '') $(this).val('Introduzca su nombre...');
			}).select();
			$('.pdf-content input[name=email]').focus(function() { 
				if($(this).val() == 'Introduzca su E-mail...') $(this).val('');
			}).blur(function() {
				if($(this).val() == '') $(this).val('Introduzca su E-mail...');
			});
		});
