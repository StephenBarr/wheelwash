...
<div class="main-container about">
  <div class="main wrapper clearfix">
    <h1>Acerca de Wheelwash</h1>
    <h2>Ofreciendo una elección y servicio inigualable</h2>
    <div class="divide">
      <p>Desde 1990, Wheelwash ha estado proporcionando sistemas eficientes de limpieza de ruedas y respetuosos al medioambiente.  Sus sistemas evitan que los vehículos de obra y maquinaria extiendan la tierra y escombros a las vías públicas. Nuestra unidad patentada “Drive through bath” fue el primero de este tipo hace 25 años y sigue siendo un elemento básico en nuestra flota actual. Nuestra gama se ha desarrollado desde entonces para incluir una variedad de sistemas de lavado de rociado de alta presión con el reciclaje de agua y muchos otros tipos que suministramos a los clientes a nivel mundial.</p>
	<p>Nuestro equipo técnico tiene mucho conocimiento y experiencia en el diseño y la especificación de los sistemas de lava ruedas que significa que podemos recomendar el producto adecuado para usted. Esto a veces implica la fabricación de soluciones de limpieza a medida para cumplir con los requisitos específicos del cliente.</p>
	<p>Nos enorgullecemos en ofrecer un servicio excepcional en el apoyo técnico, una garantía sólida y una gama completa de piezas de repuesto. Nuestros contratos de mantenimiento aseguran que nuestros ingenieros mantienen que nuestros sistemas estén funcionando de manera óptima, independientemente de su localización en todo el mundo.</p> 
	<p>Wheelwash Ltd está acreditado con el ISO 9001: 2008</p>
	<p>Nuestra oficina central se encuentra en Cheshire, Reino Unido, desde donde se coordinan las operaciones a nivel mundial.</p>
    </div>
    <h2>Mision</h2>
    <ul class="about-list">
      <li>Proporcionar a los clientes el sistema de lava ruedas mas adecuado adecuado, los accesorios y repuestos que su sitio requiere según el asesoramiento del personal de Wheelwash.</li>
	  <li>Proporcionar al cliente una experiencia tan positiva que los clientes querrán volver.</li>
	  <li>Aumentar la rentabilidad y cuota de mercado a través de la innovación de productos y excelente servicio al cliente con un enfoque especial en el servicio post venta.</li>
    ...
    <ul class="about-list">
      <li>Escuchar las necesidades del cliente, las expectativas y las restricciones presupuestarias </li>
	  <li>Proporcionar una respuesta profesional en el momento oportuno</li>
	  <li>Suministrar el sistema mas adecuado para el trabajo a un precio justo</li> 
	  <li>Hacer lo que decimos</li>
	  <li>Estar disponible para hacer frente a las preguntas, consultas y quejas</li>
	  <li>Ser sincero acerca de los costos y gastos</li>
	  <li>Proporcionar un servicio post venta excelente</li>
	  <li>Responder de manera positiva al feed-back cliente</li>
    </ul>
