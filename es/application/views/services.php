...
<div class="main-container services">
  <div class="main wrapper clearfix">
    <h1>SERVICIOS</h1>
    <p>Wheelwash adopta un enfoque centrado en el cliente, ofreciendo una gama de servicios que cubre el entero ciclo de vida de su sistema de lava ruedas, independientemente si decide alquilar o comprar. </p>
    <p>Como estándar, nuestro equipo de especialistas ofrece:</p>
    <ul class="services-list">
      <li>Asesoramiento profesional por teléfono y/o in situ.</li>
      <li>Una cotización detallada teniendo en cuenta las limitaciones del sitio.</li>
      <li>Fichas técnicas del producto.</li>
      <li>Dibujos técnicos.</li>
      <li>Diseño de sistemas fabricados a medida.</li>
      <li>Representaciones visuales de los sistemas en situ.</li>
      <li>Evaluaciones de riesgo.</li>
      <li>Comunicación continúa durante todo el proyecto.</li>
    </ul>
    <ul class="services-list">
      <li>Entrega programada del sistema.</li>
      <li>Equipo de instaladores certificados y capacitados.</li>
      <li>Formación in-situ para el personal operativo.</li>
      <li>Ingenieros dedicados para el mantenimiento y reparación.</li>
      <li>Piezas de repuesto.</li>
      <li>Asesoramiento en la gestión de sedimentos.</li>
      <li>Contratos de mantenimiento.</li>
      <li>Actualizaciones.</li>
      <li>Recogida programada de las unidades de alquiler.</li>
    ...
    <p>Wheelwash asegura que cada cliente tiene el número de contacto directo de un ingeniero capacitado en el improbable caso de que surja un problema en el sitio.</p>
    <h2>Contratos de Mantenimiento Flexibles</h2>
    ...
    <p>Necesita una báscula de puente? Ponganse en contacto con nuestros colegas de Weightron Bilanciai en<br /><b>+ 44 (0)800 0197719</b>, el principal fabricante de básculas de puentes y software de gestión del Reino Unido.</p>
    <div class="line"></div>
  </div>
</div>
